...
GNN Final Project: A marriage between cryo-TEM and SBI.

## Roadmap

`src/roadmap.ipynb` features the main goals for this project and implements them in a static fashion for both clarity and reliability.

## Local web playground

The interactive Cat Projector is built with Streamlit:
...
For development, you can edit Markdown content directly in `src/app/content/` and debug widget logic from `src/app/widgets/` independently in Python scripts or notebooks.
