...
Essentially, the reason for that is another fundamental result of our course: **low spatial frequencies mostly carry global morphology while higher spatial frequencies encode fine details, edges, and subtle structure that reconstruction quality depends on.**

Once you know that, masking and modulation in Fourier space should stop feeling arbitrary and start feeling operational and make sense to you. Go back and really convince yourself of the explanation above and try to connect it to your manipulations.
